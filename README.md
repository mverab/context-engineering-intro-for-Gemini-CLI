...
This template doesn't focus on RAG and other tools with context engineering because I have a LOT more in store for that soon. ;)
...
- Add your conventions to `GEMINI_CLI.md`
